...
const Users = [
  {
    ...
    answers:
      "Es la ciencia que se encarga del estudio y aplicación del tratamiento automatico de la información. "
  },
  {
    id: "1",
    question: "¿Qué significa informática?",
    answers:
      " Es de origen francés aprecio en 1962 que quiere decir información y automática."
  },
  {
    id: "2",
    question: "¿Quien invento la primera maquina?",
    answers: "El matemático alemán Goufried Von Leibniz en 1673."
  },
  {
    id: "3",
    question: "¿Que es la computadora? ",
    answers:
      "Es un sistema electrónico que permite la entrada de datos, el procesamiento y almacenamiento de los mismos."
  },
  {
    id: "4",
    question: "¿Que es hardware?",
    answers:
      "Son los componentes  físicos y tangibles, es decir las partes  que se pueden ver y tocar."
  },
  {
    id: "5",
    question: "¿Que es software?",
    answers:
      "Son las partes intangibles y lógicos, que posibilitan que la computadora realice todos los procesos.",
    color: "#293462"
  },
  {
    id: "6",
    question: "¿Que son los dispositivos de entrada?",
    answers:
      "Son elementos que permiten al usuario  introducir datos, información, comandos y programas de computadora.",
    color: "#293462"
  },
  {
    id: "7",
    question:
      "Son programas que se introducen en nuestra computadora de forma muy diversa con el objetivo de aserle daño a nuestra información:",
    answers: "Es el Virus.",
    color: "#293462"
  },
  {
    id: "8",
    question: "¿¿Que es la internet? ",
    answers:
      "Es el sistema de comunicaciones global que enlasa a miles de redes individual y es por ello se le conoce como la red de redes.",
    color: "#293462"
  },
  {
    id: "9",
    question: "¿Menciona 3 tipos de sistemas operativos diferentes?",
    answers: "Mac, Linux, Windows 10",
    color: "#293462"
  },
  {
    id: "10",
